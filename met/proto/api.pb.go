...
var file_api_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x32, 0xeb, 0x04, 0x0a, 0x03, 0x4d, 0x65, 0x74, 0x12, 0x26, 0x0a, 0x06, 0x52, 0x65,
...
var file_api_proto_depIdxs = []int32{
	...
	19, // 18: met.Met.Shutdown:input_type -> google.protobuf.Empty
	0,  // 19: met.Met.Report:output_type -> met.Status
	1,  // 20: met.Met.GetWorkers:output_type -> met.WorkersResponse
	3,  // 21: met.Met.GetWorker:output_type -> met.WorkerResponse
	4,  // 22: met.Met.GetWorkerProc:output_type -> met.ProcResponse
	5,  // 23: met.Met.GetWorkerCpu:output_type -> met.CpuResponse
	6,  // 24: met.Met.GetWorkerMem:output_type -> met.MemResponse
	7,  // 25: met.Met.GetWorkerNet:output_type -> met.NetResponse
	8,  // 26: met.Met.GetWorkerUptime:output_type -> met.UptimeResponse
	9,  // 27: met.Met.GetWorkerLoadAvg:output_type -> met.LoadAvgResponse
	11, // 28: met.Met.GetPoolLoad:output_type -> met.PoolLoadResponse
	19, // 29: met.Met.Shutdown:output_type -> google.protobuf.Empty
