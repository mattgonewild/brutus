...
func (x *permConnectClient) Send(m *Combination) error {
	return x.ClientStream.SendMsg(m)
}

func (x *permConnectClient) Recv() (*Permutation, error) {
	m := new(Permutation)
...
func (x *permConnectServer) Send(m *Permutation) error {
	return x.ServerStream.SendMsg(m)
}

func (x *permConnectServer) Recv() (*Combination, error) {
	m := new(Combination)
